...
trait GeneralUtilsTrait {
	...
	public static function loader_html( $prefix = null ) {
		?>
		<div style="width:100%;height:100%;position:absolute;left:0;top:0;z-index:1000;display:none;" class="loader <?php echo esc_attr( ! empty( $prefix ) ? $prefix . '-loader' : '' ); ?>">
			<div style="position:sticky;top:30%;text-align:center;">
	 ...
	 * @return void
	 */
	protected function handle_enqueue_assets( $assets ) {
